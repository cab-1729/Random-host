...
Blocks of code are either fenced by lines with three back-ticks `print("hello")`{.python} , or are indented with four spaces. I recommend only using the fenced code blocks -- they're easier and only they support syntax highlighting.
